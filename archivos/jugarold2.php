...
if ($rows==0) echo "ERROR.... No se han definido encuentros que jugar o la tabla que indica que encuento viene esta vacio....";
 ...
 <script type="text/javascript">
	...
	<body background="../imagenes/FONDO RETO 52.jpg" style="background-repeat : no-repeat;">
	...
	<table align="center" border="1" style="border-style:dashed;" background="../imagenes/div5.png" style="background-repeat : repeat-x;">
		<tr>
			<td width="342">
            	<table width="100%">
                	<tr>
                    	<td valign="bottom" width="50%" >
							<div id="divTurno1" style="font-weight:bold; font-size:18px; <?=$divColorTurno1?>"><?=$turnos1?>
							<img onclick="cambiarTurno();" id="imgTurno1" src="<?=$imgSRCTurno1?>" />&nbsp; <?=$field["Nombre1"]?> 
						</div>
                        	...
                        	<img src="../logos/<?=$field['logo1']?>" alt="" width="110" height="110" border="0" />
             
                        </td>
                        <td width="50%"  align="center" valign="center" style="font-weight:bold; font-size:20px; color:#FF0000"><div id="divPuntos1" style="font-weight:bold; font-size:30px; color:#FF0000"><?=$field["Puntos1"]?></div>Puntos</td>
                    </tr>
                </table>
			</td>
			<td width="342">
            	<table width="100%">
                	<tr>
                    	<td valign="bottom" width="50%" >
							<div id="divTurno2" style="font-weight:bold; font-size:18px; <?=$divColorTurno2?>"><?=$turnos2?>
							<img onclick="cambiarTurno();" id="imgTurno2" src="<?=$imgSRCTurno2?>" />&nbsp; <?=$field["Nombre2"]?> 
						</div>
                        	...
                        	<img src="../logos/<?=$field['logo2']?>" alt="" width="110" height="110" border="0" />
    
                        </td>
                        <td width="50%"  align="center" valign="center" style="font-weight:bold; font-size:20px; color:#FF0000"><div id="divPuntos2" style="font-weight:bold; font-size:30px; color:#FF0000"><?=$field["Puntos2"]?></div>Puntos</td>
                    </tr>
                </table>
			</td>
			<?php if ($field["Equipo3"]!="0") {	?>	
                <td width="342">
                    <table width="100%" >
                        <tr>
                            <td valign="bottom"  width="50%" >
								<div id="divTurno3" style="font-weight:bold; font-size:18px; <?=$divColorTurno3?>"><?=$turnos3?>
							<img onclick="cambiarTurno();" id="imgTurno3" src="<?=$imgSRCTurno3?>" />&nbsp; <?=$field["Nombre3"]?> 
						</div>
								...
								<img src="../logos/<?=$field['logo3']?>" alt="" width="110" height="110" border="0" />
                               
                            </td>
                            <td  width="50%"  align="center" valign="center" style="font-weight:bold; font-size:20px; color:#FF0000"><div id="divPuntos3" style="font-weight:bold; font-size:30px; color:#FF0000"><?=$field["Puntos3"]?></div>Puntos</td>
                        </tr>
                    </table>
                </td>
			<?php } ?>
	...
	<table align="center" >
      <tr>
        <td width="1043" height="194" background="../imagenes/pregunta.png" style="background-repeat : no-repeat;" align="center" valign="top">
			<div valign="top" id="divPregunta" style="font-weight:bold;  font-size:22px; margin-top:30px; margin-right:15px; margin-left:30px;"></div>
		</td>
      </tr>
    </table>
	...
	<table align="center">
      <tr>
        <td width="396" height="116" id="tdOpcionA" style="background:url('../imagenes/div3.png');background-repeat : no-repeat;" onclick="seleccionarOpcion('A')">
		  <table width="99%">
              <tr id="trOpcionA">
		...
		<td width="250" rowspan="2" align="center" valign="bottom">
			...
			if ($field["CodRonda"]=="1" or $field["CodRonda"]=="2") {
				...
				<table  border="1" style="border-style:dashed;" background="../imagenes/div5.png" style="background-repeat : repeat-x;"><tr><td align="center"><span id="segundos" style="color:red; font-weight:bold;  font-size:62px; ">10</span></td></tr>
				<tr><td align='center'><input type="button" name="btResponder" id="btResponder" value="Responder" onclick="detenerse();procesarRespuesta();" disabled="disabled" style="width:175px; font-size:14px; font-weight:bold; letter-spacing:5px;" /></td></tr>
				</table>
				</div>
				<?
			} else {
				...
				<table border="1" style="border-style:dashed;" background="../imagenes/div5.png" style="background-repeat : repeat-x;"><tr><td align="center"><span id="segundos" style="color:red; font-weight:bold;  font-size:62px; " align="center">60</span></td></tr>
				<tr><td><input type="button" name="btResponder" id="btResponder" value="Responder" onclick="detenerse();procesarRespuesta();" disabled="disabled" style="width:175px; font-size:14px; font-weight:bold; letter-spacing:5px; "/></td></tr>
        ...
        <td width="396" height="116" style="background:url('../imagenes/div3.png');background-repeat : no-repeat;" onclick="seleccionarOpcion('B')">
		  <table width="99%">
              <tr id="trOpcionB">
      ...
      <tr>
        <td width="396" height="116" style="background:url('../imagenes/div3.png');background-repeat : no-repeat;" onclick="seleccionarOpcion('C')">
		  <table width="99%">
              <tr id="trOpcionC">
        ...
        <td width="396" height="116" style="background:url('../imagenes/div3.png');background-repeat : no-repeat;" onclick="seleccionarOpcion('D')">
		  <table width="99%">
              <tr id="trOpcionD">
	...
	if ($rows2!=0) {
		...
		while($preguntas=mysql_fetch_array($query2)) {
			...
			echo "<td><input type='button' name='".$preguntas['Numero']."' id='".$preguntas['Numero']."' value='".$i."' style='width:40px; height:25px; vertical-align:text-top; font-weight:bold; font-size:16px; color:$color;' onclick='carga(".$field["CodRonda"]."); procesarPregunta(this.id);' $disabled /></td>";
